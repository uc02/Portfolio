  ...
  return (
    <div
      ...
      <div className='flex flex-col md:items-center items-start xl:gap-y-10 gap-y-3 xl:mb-0 md:mb-20 mb-0'>
        <h1 className='flex flex-col xl:space-y-8 md:space-y-4 space-y-2 xl:text-6xl md:text-4xl text-3xl md:font-normal font-bolder mt-8 md:mt-0'>
          ...
          <span className='xl:text-6xl md:text-4xl text-2xl tracking-wider xl:py-4 py-2 overflow-hidden text-center'>
            ...
            <span className={`inline-block xl:w-[380px] md:w-[240px] w-[160px] lg:ml-6 ml-2 font-extrabold
              ${isRotating ? 'hidden md:rotate-[100deg]' : 'rotate-0'} transform origin-left transition-transform duration-300 ease-out
              `}> {currentText}
            </span>{' '}
            Web Developer
          </span>
        ...
        <button className='xl:w-[400px] md:w-[300px] w-[270px] bg-gray-900 dark:bg-gray-200 md:py-1 py-0 md:px-4 px-2 xl:text-xl  md:text-xl text-base text-white dark:text-gray-900 tracking-widest rounded-r-4xl flex justify-between items-center md:mr-auto md:mx-0 mx-auto transition-colors duration-500'
        ...
        >
          ...
          <div
            className={`xl:h-[150px] h-[100px] px-3 xl:text-lg md:text-base text-xs font-light text-gray-900 dark:text-gray-200 text-justify overflow-y-auto tracking-wide origin-top custom-scrollbar
            ${isTextVisible ? 'scale-y-100' : 'scale-y-0'}
             transition-transform duration-300`}
          >
            <p
              className='xl:py-3 py-1 px-1 [&::first-letter]:text-[30px] [&::first-letter]:ml-5  [&::first-letter]:text-red-500 dark:[&::first-letter]:text-yellow-500'>
              {aboutText}
            </p>
          </div>
        </div>
